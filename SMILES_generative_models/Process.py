...
if 'generative_models' not in sys.modules:
    generative_models = types.ModuleType('generative_models')
    generative_models.__path__ = [str(repo_root)]
    sys.modules['generative_models'] = generative_models
KOSTIL_FOR_PICKL = sys.modules['generative_models']
