...
from autodock_vina_python3.src.utils.paths import get_project_path
import numpy as np 
from autodock_vina_python3.src.utils.prepare_receptor import prepare_pdb, get_center_of_protein, get_bounding_box
from autodock_vina_python3.src.utils.prepare_ligand import preprocess_ligand
import pandas as pd
...
path = 'Sber_Alzheimer/train_cVAE_sber_altz_docking/alzh_gen_mols/valid_mols_wo_dupls0_mp_ic50_6.csv'
...
for i,smile in enumerate(tqdm(smiles)):
    ...
    if i%10==0:
        ...
        db_dock.to_csv('Sber_Alzheimer/train_cVAE_sber_altz_docking/alzh_gen_mols/valid_mols_wo_dupls0_mp_ic50_6_docking.csv')
