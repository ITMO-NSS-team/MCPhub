...
if __name__ == "__main__":
    ...
    CASE = 'CYK'
    train_data = 'docked_data_for_train/data_4j1r.csv'
    conditions = ['docking_score','QED','Synthetic Accessibility','PAINS','SureChEMBL','Glaxo','Brenk','IC50']
    test_mode = False
    url = "http://10.64.4.247:81"
    n_samples = 10000
    load_weights = 'autotrain/train_ALZHEIMER_2/ALZHEIMER/weights/epo2'
    load_weights_fields = 'autotrain/train_ALZHEIMER_2/ALZHEIMER/weights/epo2'
