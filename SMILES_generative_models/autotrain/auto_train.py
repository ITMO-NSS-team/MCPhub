...
def main_generate(server_dir = 'train_dislip',
         conditions : List[str] = ['ic50'],
         case:str = 'Alzhmr',
         test_mode = False,
         state = None,
...
if __name__ == "__main__":
    ...
    n_samples = 10
    load_weights = 'autotrain/train_Alzheimer_1_prop/Alzheimer_1_prop/weights/epo6'#'autotrain/train_ALZHEIMER_2/ALZHEIMER/weights/epo2'
    load_weights_fields = 'autotrain/train_Alzheimer_1_prop/Alzheimer_1_prop/weights/epo6'#'autotrain/train_ALZHEIMER_2/ALZHEIMER/weights/epo2'
    ...
    main(conditions = state(CASE,'ml')['target_column'],
         case=CASE, 
         server_dir = f'autotrain/train_{CASE}',
