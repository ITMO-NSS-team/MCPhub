...
class Config_P(BaseModel):
    ...
    imp_test:bool = False
    data_path_with_conds:str = 'Sber_Alzheimer/train_cVAE_sber_skleroz_docking/docked_data_4j1r.csv'
    epochs : int = 15
    cuda : bool = True
    ...
    batchsize : int = 2048
    max_strlen : int = 100
    load_weights:Union[str,None] = 'Sber_Alzheimer/train_cVAE_sber_altz_docking/weights'
...
def configurate_parser(import_path : str,
                       save_folder_name : str,
                       imp_test = False,
                       data_path_with_conds = 'Sber_Alzheimer/train_cVAE_sber_skleroz_docking/docked_data_4j1r.csv',
                       epochs : int = 15,
                       cuda : bool = True,
                       lr_scheduler : str = 'SGDR',
                       lr_max : float = 0.005,
                       ...
                       batchsize : int = 2048,
                       max_strlen : int = 100,
                       load_weights = 'Sber_Alzheimer/train_cVAE_sber_altz_docking/weights',
    ...
    Args:
        ...
        src_data (str, optional): Train data with smiles path. Defaults to '/data/ChEMBL_ic50.csv'.
        src_data_te (str, optional): Train data with smiles path. Defaults to '/data/ChEMBL_ic50.csv'.
        trg_data (str, optional): Train data with smiles path. Defaults to '/data/ChEMBL_ic50.csv'.
        trg_data_te (str, optional): Train data with smiles path. Defaults to '/data/ChEMBL_ic50.csv'.
        ...
        cond_test_path (str, optional): Train data with smiles and conditions path. Defaults to '/nfs/home/gsololvyev/AAAI_code/GAN/ChEMBL_training/data/database_ChEMBL_ic50.csv'.
        cond_train_path (str, optional): Train data with smiles and conditions path. Defaults to '/nfs/home/gsololvyev/AAAI_code/GAN/ChEMBL_training/data/database_ChEMBL_ic50.csv'.
