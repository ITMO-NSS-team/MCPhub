...
def Ic50(mol:List[str]):  
    ...
    model =  pi.load(open('ic50_classifire_model/kinase_inhib.pkl','rb')) 
...
if __name__ == "__main__":
    ...
    mols = pd.read_csv('train_data/alzh_gen_mols/mols_generated_mols0.csv')
    #pd.read_csv('/nfs/home/gsololvyev/AAAI_code/TVAE/generate/cvae_gen/valid/valid_mols_wo_dupls_cvae_0.csv')['0']
    ...
    #mols.to_csv('/nfs/home/gsololvyev/AAAI_code/GAN/ChEMBL_training/data/database_ChEMBL_ic50.csv')
