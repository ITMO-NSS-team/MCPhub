...
def train_gen_with_data(
    case = "Alzheimer",
    data_path = "docked_data_for_train/data_4j1r.csv",#path to client data folder
...
if __name__=='__main__':
    ...
    #                     fine_tune=True,
    #                     data_path='docked_data_for_train/data_cyk_short.csv',
    #                     epochs=3)
    ...
    #                     fine_tune=True,
    #                     data_path='/projects/CoScientist/autotrain/data.csv',
    #                     epochs=2)
