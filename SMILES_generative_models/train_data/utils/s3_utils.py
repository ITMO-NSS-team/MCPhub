...
s3_service = S3BucketService(
    endpoint="###",#/buckets/molecule-generative-mcp
    access_key="####",
    secret_key="###",
    bucket_name="###"
)
...
if __name__ == "__main__":
   s3_service.upload_file_object(prefix="state",
                                              source_file_name="state.json",
                                              file_path=r"D:\Projects\testmcp\MCPhub\automl\state.json")
