...
s3_service = S3BucketService(
    endpoint="http://10.32.1.114:9000",#/buckets/molecule-generative-mcp
    access_key="chemcoscientist-user",
    secret_key="qCpy52Y8NS2+@J4",
    bucket_name="molecule-generative-mcp"
)

if __name__ == "__main__":
   s3_service.upload_file_object(prefix="train",
                                              source_file_name="Test_mas_1.csv",
                                              file_path=r"D:\Projects\testmcp\MCPhub\SMILES_generative_models\docked_data_for_train\data_4j1rcopy.csv")

    #buckets = s3_client.list_objects()
