...
cases = {'Alzhmr' : 
        ...
        {'docking_path' :'autodock_vina_python3/data/skleroz/target_BTK.pdb',
         ...
         'KI':None,
         'anti_docking_path':None#{'BMX':'autodock_vina_python3/data/skleroz/BMX_8x2a_protein.pdb'}
         },

         'Prkns':
        {'docking_path' :'autodock_vina_python3/data/parkinson/Catechol_O_methyltransferase.pdb',
        ...
        {'docking_path' :'autodock_vina_python3/data/Canser/8afb_protein.pdb',
         ...
         'KI':None,
         'anti_docking_path':None#{'NRAS':'autodock_vina_python3/data/Canser/NRAS_3con_protein.pdb',
                              #'HRAS':'autodock_vina_python3/data/Canser/HRAS_3k8y_protein.pdb'}
         },

         'Dslpdm':
        {'docking_path' :'autodock_vina_python3/data/dislipidemia/Proprotein_Convertase_SubtilisinKexin_Type_9.pdb',
        ...
        {'docking_path' :'autodock_vina_python3/data/Signal_Transducer_and_Activator_of_Transcription_3.pdb',
         ...
         'RNDM':
         {'docking_path' :'autodock_vina_python3/data/target_BTK.pdb',
...
def all_prop_calc(path_to_data:str,
                   ...
                   calc_docking = False,
                   gen_data = True,
                   train_data_path:str='docked_data_4j1r.csv',
                   calc_ic50 = True
                   ):
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('utils/result_context.csv')
    df_t = df.dropna()
    ...
    df_t.to_csv('utils/result_context2.csv')
    ...
    #               calc_docking=True,
    #               gen_data=True,
    #               train_data_path = 'GAN/ChEMBL_training/chembl_filtered_400w_150s.csv')
